...
<div class="container">
	<div class="row">
		<h1 class="text-center">Seguro Colombiano- SOAT Vencidos</h1>
	</div>
	...
	<div class="row">
		...
		<?php $this->widget('booster.widgets.TbGridView', array(
			...
			'columns'=>array(
				...
				array('name'=>'veh_seg_num_pol2', 'htmlOptions'=>array('width'=>'100'), 
					'value'=>'$data->veh_seg_num_pol2', 'header' => 'Póliza Seg. Colombiano 1'),
				array('name'=>'veh_seg_fec_ven2', 'htmlOptions'=>array('width'=>'100'), 
					'value'=>'$data->veh_seg_fec_ven2', 'header' => 'Fech. Ven. Seg. Colombiano 1'),
