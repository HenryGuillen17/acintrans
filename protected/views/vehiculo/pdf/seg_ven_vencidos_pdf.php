...
<div class="container">
	<div class="row">
		<h1 class="text-center">Seguros Venezolanos Vencidos</h1>
	</div>
	...
	<div class="row">
		...
		<?php $this->widget('booster.widgets.TbGridView', array(
			...
			'columns'=>array(
				...
				array('name'=>'veh_seg_num_pol1', 'htmlOptions'=>array('width'=>'100'), 
					'value'=>'$data->veh_seg_num_pol1', 'header' => 'Póliza Seg. Venezolano'),
				array('name'=>'veh_seg_fec_ven1', 'htmlOptions'=>array('width'=>'100'), 
					'value'=>'$data->veh_seg_fec_ven1', 'header' => 'Fech. Ven. Seg. Venezolano'),
			),
		)); ?>
	</div>
	<?php endif ?>
